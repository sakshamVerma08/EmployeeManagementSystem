...
const Signup = ({ setUser }) => {
  ...
  const handleSubmit = (e) => {
    ...
    const emailExists = [...(userData || []), ...(adminData || [])].some(
    ...
    // Update context and localStorage based on role
    if (role === "employee") {
      ...
      localStorage.setItem(
        "loggedInUser",
        JSON.stringify({ role: "employee", data: newUser })
      );
      navigate("/employee");
    } else {
      ...
      localStorage.setItem(
        "loggedInUser",
        JSON.stringify({ role: "admin", data: newUser })
      );
      navigate("/admin");
    }
